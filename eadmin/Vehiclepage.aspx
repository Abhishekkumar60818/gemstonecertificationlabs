<%@ Page Title="" Language="C#" MasterPageFile="~/eadmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Vehiclepage.aspx.cs" Inherits="eadmin_Vehiclepage" %>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <asp:Button ID="btndisablsed" runat="server" Text="Hide" CssClass="btn btn-danger" OnClick="btndisablsed_Click"   />
                                    ...
                                    <div class="panel-body">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtNameUp" runat="server" class="form-control"></asp:TextBox>
                                             ...
                                             <div class="form-group">
                                            <label>Rent</label>
                                            <asp:TextBox ID="txtRs" runat="server" class="form-control"></asp:TextBox>
                                        </div> 
                            ...
                            <div class="tab-pane fade" id="addnew">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body"> <div class="col-md-6">
                                         ...
                                         <div class="form-group" >
                                            <label>Rs.</label>
                                            <asp:TextBox ID="txtRent" runat="server" class="form-control"></asp:TextBox>
                                        </div> 
                                      <div class="form-group" style="display:none;">
                                            <label>Image</label>
