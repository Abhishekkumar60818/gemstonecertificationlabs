...
public partial class eadmin_dropdownlist : System.Web.UI.Page
{
    string extension;
    static int upid;
    ...
    private void fillMedicineType()
    {
        ...
        dropdownlistData sdata = new dropdownlistData();
        DataSet ds = sdata.getMedicineType("select * from dropdownlist");
    ...
    protected void rpMedicineType_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (command == "edit")
            {
                ...
                dropdownlistData mtdata = new dropdownlistData(id);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //    fileName = fileNameUp;
            //}
            dropdownlistData mtdata = new dropdownlistData();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        fillMedicineType();
        panelMessage.Visible = true;
        Response.Redirect("dropdownlist.aspx");
    }
