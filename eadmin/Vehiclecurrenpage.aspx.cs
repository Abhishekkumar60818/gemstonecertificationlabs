...
public partial class eadmin_Vehiclecurrenpage : System.Web.UI.Page
{
    string extension;
    static int upid;
    ...
    private void fillMedicineType()
    {
        ...
        vehiclepageData sdata = new vehiclepageData();
        DataSet ds = sdata.getMedicineType("select * from vehiclecurrentdb");
    ...
    protected void rpMedicineType_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (command == "edit")
            {
                ...
                vehiclepageData mtdata = new vehiclepageData(id);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //    fileName = fileNameUp;
            //}
            vehiclepageData mtdata = new vehiclepageData();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rpMedicineType.Items.Count; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                sdata.Delete("delete from vehiclecurrentdb where id=" + chk.Text);

            }
        }
        fillMedicineType();
        panelMessage.Visible = true;
        Response.Redirect("Vehiclecurrenpage.aspx");
    }
