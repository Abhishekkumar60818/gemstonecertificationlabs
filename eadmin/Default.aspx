<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="eadmin_Default" %>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4"><asp:Label ID="lblMessage" runat="server"></asp:Label></div>
                <div class="col-md-4">
                    <div class="panel-warning panel">
                        ...
                        <div class="panel-body">
                            ...
                            <hr />
                            <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-info" Text="Login Me" OnClick="btnLogin_Click"/>
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2015 EDawa | By : <a href="http://www.par-ken.com/" target="_blank">Parken Solution Pvt. Ltd</a>
                </div>
