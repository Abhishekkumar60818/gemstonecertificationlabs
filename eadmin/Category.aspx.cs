...
public partial class Category : System.Web.UI.Page
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        //        // categoryImg.SaveAs(HttpContext.Current.Server.MapPath("~/Admin/category/" + FileName));
        //        ImageResizeNew rmg = new ImageResizeNew();
        //        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/small/" + categoryImg.FileName), 108, 108);
        //        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/medium/" + categoryImg.FileName), 224, 224);
        //        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/large/" + categoryImg.FileName), 300, 300);
        //        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/xlarge/" + categoryImg.FileName), 500, 500);
    ...
    protected void tvCategores_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        if (selectedNode.Parent == null)
        {
            ...
            catimgup.ImageUrl = "~/Admin/category/small/" + cdata.Image;
    ...
    {
        CategoryData cdata = new CategoryData(int.Parse(e.CommandArgument.ToString()));
        idup = cdata.Id;
        txtCategoryUp.Text = cdata.Category;
        txtDescriptionUp.Text = cdata.Description;
        txtPageTitleUp.Text = cdata.PageTitle;
        txtMetaKeyUp.Text = cdata.MetaKeyes;
        txtMetaDescriptionUp.Text = cdata.MetaDescription;
        catimgup.ImageUrl = "~/eadmin/category/small/" + cdata.Image;
        FileNameUp = cdata.Image;
        updatePanel.Visible = true;
        addPanel.Visible = false;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //        ImageResizeNew rmg = new ImageResizeNew();
        //        rmg.GenerateThumbnails(0.5, categoryImgUp.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/small/" + categoryImgUp.FileName), 108, 108);
        //        rmg.GenerateThumbnails(0.5, categoryImgUp.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/medium/" + categoryImgUp.FileName), 224, 224);
        //        rmg.GenerateThumbnails(0.5, categoryImgUp.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/large/" + categoryImgUp.FileName), 300, 300);
        //        rmg.GenerateThumbnails(0.5, categoryImgUp.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/category/xlarge/" + categoryImgUp.FileName), 500, 500);
        //    }
        //    else
        //    {
        //        FileName = FileNameUp;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rpCategory.Items.Count; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                pdata.Delete("delete from subcategory where categoryid=" + chk.Text);
            ...
            if (uploadCatImage.HasFile)
            {
                foreach (HttpPostedFile postedFile in uploadCatImage.PostedFiles)
                {
                    ...
                    if (cdata.HasValue)
                    {
                        ...
                        ImageResizeNew rmg = new ImageResizeNew();
                        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/Admin/category/small/" + categoryImg.FileName), 108, 108);
                        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/Admin/category/medium/" + categoryImg.FileName), 224, 224);
                        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/Admin/category/large/" + categoryImg.FileName), 300, 300);
                        rmg.GenerateThumbnails(0.5, categoryImg.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/Admin/category/xlarge/" + categoryImg.FileName), 500, 500);
                    }
