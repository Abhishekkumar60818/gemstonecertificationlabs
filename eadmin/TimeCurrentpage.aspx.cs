...
public partial class eadmin_TimeCurrentpage : System.Web.UI.Page
{
    string extension;
    static int upid;
    ...
    private void fillMedicineType()
    {
        ...
        TimecurrentpageDate sdata = new TimecurrentpageDate();
        DataSet ds = sdata.getMedicineType("select * from timecurrentdb");
    ...
    protected void rpMedicineType_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (command == "edit")
            {
                ...
                TimecurrentpageDate mtdata = new TimecurrentpageDate(id);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //    fileName = fileNameUp;
            //}
            TimecurrentpageDate mtdata = new TimecurrentpageDate();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rpMedicineType.Items.Count; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                sdata.Delete("delete from timecurrentdb where id=" + chk.Text);

            }
        }
        fillMedicineType();
        panelMessage.Visible = true;
        Response.Redirect("TimeCurrentpage.aspx");
    }
