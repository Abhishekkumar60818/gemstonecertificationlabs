...
public partial class eadmin_ZoneCurrentpage : System.Web.UI.Page
{
    string extension;
    static int upid;
    ...
    private void fillMedicineType()
    {
        ...
        zonecurrentpageData sdata = new zonecurrentpageData();
        DataSet ds = sdata.getMedicineType("select * from zonecurrentdb");
    ...
    protected void rpMedicineType_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (command == "edit")
            {
                ...
                zonecurrentpageData mtdata = new zonecurrentpageData(id);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //    fileName = fileNameUp;
            //}
            zonecurrentpageData mtdata = new zonecurrentpageData();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rpMedicineType.Items.Count; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                sdata.Delete("delete from zonecurrentdb where id=" + chk.Text);

            }
        }
        fillMedicineType();
        panelMessage.Visible = true;
        Response.Redirect("ZoneCurrentpage.aspx");
    }
