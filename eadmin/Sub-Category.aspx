<%@ Page Title="" Language="C#" MasterPageFile="~/eadmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Sub-Category.aspx.cs" Inherits="Sub_Category" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#update" data-toggle="tab">All Event Details</a>
                            </li>
                            <li class=""><a href="#addnew" data-toggle="tab">Add Sub-Event</a>
                            </li>
                            ...
                            <li class=""><a href="#updateExcel" data-toggle="tab" style="display:none;">Update Excel</a>
                             ...
                             <li class="" style="display:none"><a href="#uploadImage" data-toggle="tab" style="display:none;">Upload Image</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade active in" id="update">
                                ...
                                <div class="col-md-3">
                                    <div class="panel panel-default" style="display:none;">
                                        ...
                                        <div class="panel-body">
                                             <asp:TreeView ID="tvCategores" runat="server"   LeafNodeStyle-ImageUrl="~/Admin/assets/img/folder2.png" RootNodeStyle-ImageUrl="~/Admin/assets/img/folder1.png" OnSelectedNodeChanged="tvCategores_SelectedNodeChanged">
                                ...
                                <div class="col-md-9">
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                 <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <asp:Repeater ID="rpSubCategory" runat="server" OnItemCommand="rpProduct_ItemCommand" OnItemDataBound="rpProduct_ItemDataBound">
                                                            <ItemTemplate>
                                                                 <tr>
                                                            ...
                                                            <td><a href="link_product.aspx?id=<%#Eval("id") %>" style="border: 2px solid chocolate;text-decoration: none;display: inherit;background: #f1ab7a;" > View Record </a> </td>
                                                        </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Sub-Event Name </label>
                                                <asp:TextBox ID="txtSubCateUp" runat="server" CssClass="form-control" placeholder="Enter Category" />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Sub-Event Image</label>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group" style="display:none;">
                                                ...
                                                <CKEditor:CKEditorControl ID="txtSubCatDesUp" BasePath="~/Admin/ckeditor/" runat="server" Toolbar="Source
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group" style="display:none;">
                                                <label for="exampleInputEmail1">Sub-Category Description</label>
                                                <CKEditor:CKEditorControl ID="txtSubDescription" BasePath="~/Admin/ckeditor/" runat="server" Toolbar="Source
Bold|Italic|Underline|Strike|-|Subscript|Superscript
NumberedList|BulletedList|-|Outdent|Indent/
Styles|Format|Font|FontSize|TextColor|BGColor"
                                                    Height="70px">
