<%@ Page Title="" Language="C#" MasterPageFile="~/eadmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="Category" %>
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#updateExcel" data-toggle="tab" style="display:none;">Update Excel</a>
                             ...
                             <li class="" style="display:none"><a href="#uploadImage" data-toggle="tab">Upload Image</a>
                            </li>
                        </ul>
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rpCategory" runat="server" OnItemCommand="rpProduct_ItemCommand" OnItemDataBound="rpProduct_ItemDataBound">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="cat_link.aspx?id=<%#Eval("id") %>" style="border: 2px solid chocolate;text-decoration: none;display: inherit;background: #f1ab7a;" > View Record </a> </td>
                                                                    </tr>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <CKEditor:CKEditorControl ID="txtDescriptionUp" BasePath="~/Admin/ckeditor/" runat="server" Toolbar="Source
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Category Description</label>
                                                <CKEditor:CKEditorControl ID="txtDescription" BasePath="~/Admin/ckeditor/" runat="server" Toolbar="Source
                                                    Bold|Italic|Underline|Strike|-|Subscript|Superscript
                                                    NumberedList|BulletedList|-|Outdent|Indent/
                                                    Styles|Format|Font|FontSize|TextColor|BGColor"
                                                    Height="70px">
