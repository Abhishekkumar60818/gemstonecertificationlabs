...
public partial class eadmin_Timepage : System.Web.UI.Page
{
    string extension;
    static int upid;
    ...
    private void fillMedicineType()
    {
        ...
        TimepageData sdata = new TimepageData();
        DataSet ds = sdata.getMedicineType("select * from timeddb");
    ...
    protected void rpMedicineType_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (command == "edit")
            {
                ...
                TimepageData mtdata = new TimepageData(id);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //    fileName = fileNameUp;
            //}
            TimepageData mtdata = new TimepageData();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rpMedicineType.Items.Count; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                sdata.Delete("delete from timeddb where id=" + chk.Text);

            }
        }
        fillMedicineType();
        panelMessage.Visible = true;
        Response.Redirect("Timepage.aspx");
    }
