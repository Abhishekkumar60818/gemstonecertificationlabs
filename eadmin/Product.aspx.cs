...
public partial class Product : System.Web.UI.Page
{
    ...
    private void fillCategory()
    {
        ...
        cmbCategoryUp.DataTextField = "Category";
        ...
        cmbCategoryEx.DataTextField = "Category";
        ...
        cmbCategoryExUp.DataTextField = "Category";
    ...
    private void fillSubCategory()
    {
        ...
        DataSet ds = cdata.getSubCategory("select * from subcategory where categoryid=" + id);
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            cmbSubCategory.Items.Insert(0, "Select Category");
        ...
        else
        {
            cmbSubCategory.DataSource = ds;
            cmbSubCategory.DataTextField = "subCategoryName";
            cmbSubCategory.DataValueField = "0";
            cmbSubCategory.DataBind();
            cmbSubCategory.Items.Insert(0, "0");
            cmbSubCategory.SelectedIndex = 0;
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (flupldImage.HasFile)
            {
                ...
                extension = flupldImage.FileName.Substring(flupldImage.FileName.LastIndexOf("."));
                var time = DateTime.Now;
                //string currentDate = time.ToString("yyyy, MM, dd, hh, mm, ss");
                ...
                string FileName = flupldImage.FileName;
                ImageResizeNew rmg = new ImageResizeNew();
                rmg.GenerateThumbnails(0.5, flupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/small/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 250, 400);
                rmg.GenerateThumbnails(0.5, flupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/large/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 450, 612);
                rmg.GenerateThumbnails(0.5, flupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/medium/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 350, 512);
                rmg.GenerateThumbnails(0.5, flupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/xlarge/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 650, 912);
                ...
                pdata.ScientificName = txtScientificName.Text.ToString();
                pdata.KnownAs = txtKnownAs.Text.ToString();
                pdata.Size = txtSize.Text.ToString();
                pdata.Code = txtCode.Text.ToString().Trim();
                pdata.Quantity = int.Parse(txtQuantity.Text.ToString());
                pdata.Image = yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName;
                //pdata.Standard = stander.Text.ToString();
                //pdata.Booktype = booktype.Text.ToString();
                //pdata.Subject = subject.Text.ToString();
                //pdata.Language = language.Text.ToString();
                //pdata.Publisher = publiser.Text.ToString();
                //pdata.Authorwriter = auther.Text.ToString();
                pdata.Save();
                ...
                msdata.Size = txtSize.Text.ToString();
                ...
                msdata.Image = yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName;
                msdata.Save();
                fillSubCategory();
                fillTree();
                fillProduct("select * from product where status=1");
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
     {
        ...
        {
            ProductData pdata = new ProductData();
            if (eflupldImage.HasFile)
            {
                extension = String.Empty;
                extension = eflupldImage.FileName.Substring(eflupldImage.FileName.LastIndexOf("."));
                var time = DateTime.Now;
                string yyyy = time.ToString("yyyy");
                string MM = time.ToString("MM");
                string dd = time.ToString("dd");
                ...
                string mm = time.ToString("mm");
                string ss = time.ToString("ss");
                string FileName = eflupldImage.FileName;
                ImageResizeNew rmg = new ImageResizeNew();
                rmg.GenerateThumbnails(0.5, eflupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/small/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 250, 400);
                rmg.GenerateThumbnails(0.5, eflupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/large/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 450, 612);
                rmg.GenerateThumbnails(0.5, eflupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/medium/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 350, 512);
                rmg.GenerateThumbnails(0.5, eflupldImage.PostedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/Products/xlarge/" + yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName), 650, 912);
                pdata.Image = yyyy + "-" + MM + "-" + dd + "-" + hh + "-" + mm + "-" + ss + "-" + FileName;
            }
            else
            {
                pdata.Image = lblImage.Text;
            }
            ...
            pdata.ScientificName = txtScientificNameUp.Text.ToString();
            pdata.Size = txtSizeUp.Text.ToString();
            pdata.KnownAs = txtKnownAsUp.Text.ToString();
    ...
    {
        idup = int.Parse(e.CommandArgument.ToString());
        ...
        else
        {
            ...
            txtScientificNameUp.Text= pdata.ScientificName;
            txtKnownAsUp.Text= pdata.KnownAs;
            txtSizeUp.Text= pdata.Size;
            txtCodeUp.Text = pdata.Code;
            txtQuantityUp.Text = pdata.Quantity.ToString();
            OldImg.ImageUrl = "Products/small/" + pdata.Image;
            lblImage.Text = pdata.Image;
        }
        ...
        try
        {
            if (excelUpload.HasFile)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    pdata.ProductType = int.Parse(dt.Rows[i][4].ToString());
                    pdata.Code = dt.Rows[i][5].ToString();
                    pdata.Description = dt.Rows[i][6].ToString();
                    pdata.Image = dt.Rows[i][7].ToString();
                    pdata.Standard = dt.Rows[i][8].ToString();
                    pdata.Booktype = dt.Rows[i][9].ToString();
                    pdata.Subject = dt.Rows[i][10].ToString();
                    pdata.Language = dt.Rows[i][11].ToString();
                    pdata.Publisher = dt.Rows[i][12].ToString();
                    pdata.Authorwriter = dt.Rows[i][13].ToString();
                    pdata.Save();
                    DataSet ds = pdata.getProduct("select max(id) from product");
                    MoreSizeData msdata = new MoreSizeData();
                    msdata.ProductId = int.Parse(ds.Tables[0].Rows[0][0].ToString());
        ...
        try
        {
            if (uploadProImage.HasFile)
            {
                foreach (HttpPostedFile postedFile in uploadProImage.PostedFiles)
                {
                    ...
                    {
                        ImageResizeNew rmg = new ImageResizeNew();
                        rmg.GenerateThumbnails(0.5, postedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/product/small/" + postedFile.FileName), 196, 196);
                        rmg.GenerateThumbnails(0.5, postedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/product/medium/" + postedFile.FileName), 224, 224);
                        rmg.GenerateThumbnails(0.5, postedFile.InputStream, HttpContext.Current.Server.MapPath("~/eadmin/product/large/" + postedFile.FileName), 300, 300);
                        rmg.GenerateThumbnails(0.5, postedFile.InputStream, HttpContext.Current.Server.MapPath("~/" + postedFile.FileName), 393, 499);
                    }
    ...
    protected void btnExcelExport_Click(object sender, EventArgs e)
    {
        ...
        CategoryData cdata = new CategoryData();
        DataSet ds = cdata.getCategory("select id,productName,price,newprice,quantity,prodtype,code,description,image,standard,booktype,subject,language,publisher,authorwriter from product where subcategoryid=" + id);
        ...
        try
        {
            if (excelUpdate.HasFile)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    pdata.Standard = dt.Rows[i][9].ToString();
                    pdata.Booktype = dt.Rows[i][10].ToString();
                    pdata.Subject = dt.Rows[i][11].ToString();

                    pdata.Language = dt.Rows[i][12].ToString();
                    pdata.Publisher = dt.Rows[i][13].ToString();
                    pdata.Authorwriter = dt.Rows[i][14].ToString();
