<%@ Page Title="" Language="C#" MasterPageFile="~/eadmin/AdminMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Product.aspx.cs" Inherits="Product" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#uploadExcel" data-toggle="tab" style="display:none;">Upload Excel</a>
                            </li>
                            <li class=""><a href="#updateExcel" data-toggle="tab" style="display:none;">Update Excel</a>
                            </li>
                            <li class=""><a href="#uploadImage" data-toggle="tab" style="display:none;">Upload Image</a>
                            </li>
                        </ul>
                                ...
                                <asp:Panel ID="viewPanel" runat="server">
                                    ...
                                    <div class="col-md-3" style="display:none">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <asp:TreeView ID="tvCategores" runat="server" LeafNodeStyle-ImageUrl="~/eadmin/assets/img/folder2.png" RootNodeStyle-ImageUrl="~/eadmin/assets/img/folder1.png" OnSelectedNodeChanged="tvCategores_SelectedNodeChanged">
                                                </asp:TreeView>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                         ...
                                                                         <td><a href="link_productpageid.aspx?id=<%#Eval("id") %>" style="border: 2px solid chocolate;text-decoration: none;display: inherit;background: #f1ab7a;" > View Record </a> </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <ContentTemplate>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtScientificNameUp" runat="server" CssClass="form-control" placeholder="Enter Scientific Name" />
                                                        </div>
                                                         <div class="form-group">
                                                            <label for="exampleInputEmail1">Known As</label>
                                                            <asp:TextBox ID="txtKnownAsUp" runat="server" CssClass="form-control" placeholder="Enter Known As" />
                                                        </div>
                                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <CKEditor:CKEditorControl ID="txtDescriptionUp" BasePath="~/eadmin/ckeditor/" runat="server" Toolbar="Source
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Pro Code</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:FileUpload ID="eflupldImage" runat="server" />
                                                    <asp:Label ID="lblImage" runat="server" Visible="false"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:Image ID="OldImg" CssClass="img-responsive" runat="server" />
                                            </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <asp:UpdatePanel ID="productUpdatePanel" runat="server">
                                            <ContentTemplate>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Scientific Name</label>
                                                        <asp:TextBox ID="txtScientificName" runat="server" CssClass="form-control" placeholder="Enter Scientific Name" />
                                                    </div>
                                                      <div class="form-group">
                                                            <label for="exampleInputEmail1">Known As</label>
                                                            <asp:TextBox ID="txtKnownAs" runat="server" CssClass="form-control" placeholder="Enter Known As" />
                                                        </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">MRP Price </label>
                                                    ...
                                                    <div class="form-group" style="display: none;">
                                                        ...
                                                        <asp:TextBox ID="txtTax" class="form-control" Text="1" placeholder="Tax" runat="server"></asp:TextBox>
                                                    </div>
                                                    <div class="form-group" style="display: none">
                                                        <label for="exampleInputEmail1">Product Type</label>
                                                        <asp:DropDownList ID="cmbProductType" runat="server" CssClass="form-control">
                                                            <asp:ListItem Value="1" Selected="True">Veg</asp:ListItem>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Product Description</label>
                                                <CKEditor:CKEditorControl ID="txtProductDescription" BasePath="~/eadmin/ckeditor/" runat="server" Toolbar="Source
                                                    Bold|Italic|Underline|Strike|-|Subscript|Superscript
                                                    NumberedList|BulletedList|-|Outdent|Indent/
                                                    Styles|Format|Font|FontSize|TextColor|BGColor"
                                                    Height="100px">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Product Image</label>
                                                <%--<asp:TextBox ID="ProductImg" type="file" CssClass="form-control" runat="server" />--%>
                                                <asp:FileUpload ID="flupldImage" runat="server" />
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="stander" runat="server" class="form-control" placeholder="Standard" TextMode="MultiLine" />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Book Type</label>
                                                <asp:TextBox ID="booktype" CssClass="form-control" runat="server" placeholder="Book Type" TextMode="MultiLine"></asp:TextBox>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="subject" runat="server" class="form-control" placeholder="Subject" TextMode="MultiLine" />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Language</label>
                                                <asp:TextBox ID="language" CssClass="form-control" runat="server" placeholder="Language" TextMode="MultiLine"></asp:TextBox>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="publiser" runat="server" class="form-control" TextMode="MultiLine" placeholder="Publisher" />
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                                <label for="exampleInputEmail1">Author-Writer</label>
                                                <asp:TextBox ID="auther" CssClass="form-control" runat="server" placeholder="Author-Writer" TextMode="MultiLine"  ></asp:TextBox>
                                            </div>
