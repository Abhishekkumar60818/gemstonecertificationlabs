<%@ Page Title="" Language="C#" MasterPageFile="~/eadmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MedicineType.aspx.cs" Inherits="eadmin_MedicineType" %>
                                                            ...
                                                            <asp:Repeater ID="rpMedicineType" runat="server" OnItemCommand="rpMedicineType_ItemCommand">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%#Eval("name") %></td>                                                              
                                                                        <td><img src="../eadmin/medicine/xlarge/<%#Eval("image")%>" width="80px" height="80px"></img></td>
                                                                        <td><%#Eval("address") %></td>
                                                                        <td>
