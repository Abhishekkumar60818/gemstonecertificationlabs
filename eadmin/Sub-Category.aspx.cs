...
public partial class Sub_Category : System.Web.UI.Page
{
    ...
    private void fillCategory()
    {
        ...
        cmbCategoryExcel.DataTextField = "category";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (subCategoryImg.HasFile)
            {
                ...
                imgCompress.Save(subCategoryImg.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/small/"));
                imgCompress.Height = 224;
                imgCompress.Width = 224;
                imgCompress.Save(subCategoryImg.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/medium/"));
                imgCompress.Height = 300;
                imgCompress.Width = 300;
                imgCompress.Save(subCategoryImg.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/large/"));
                imgCompress.Height = 500;
                imgCompress.Width = 500;
                imgCompress.Save(subCategoryImg.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/xlarge/"));
    ...
    protected void tvCategores_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            subCatImg.ImageUrl = "~/Admin/subcategory/small/" + scdata.Image;
    ...
    {
        SubCData scdata = new SubCData(int.Parse(e.CommandArgument.ToString()));
        idup = scdata.Id;
        cmbCategoryUp.SelectedValue = scdata.Catid.ToString();
        txtSubCateUp.Text = scdata.SubCategory;
        txtSubCatDesUp.Text = scdata.Description;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (subCatImgUp.HasFile)
            {
                ...
                imgCompress.Height = 108;
                imgCompress.Width = 108;
                imgCompress.Save(subCatImgUp.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/small/"));
                imgCompress.Height = 224;
                imgCompress.Width = 224;
                imgCompress.Save(subCatImgUp.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/medium/"));
                imgCompress.Height = 300;
                imgCompress.Width = 300;
                imgCompress.Save(subCatImgUp.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/large/"));
                imgCompress.Height = 500;
                imgCompress.Width = 500;
                imgCompress.Save(subCatImgUp.FileName, HttpContext.Current.Server.MapPath("~/eadmin/subcategory/xlarge/"));
            }
            else
            {
                FileName = FileNameUp;
            ...
            if (uploadSubImage.HasFile)
            {
                foreach (HttpPostedFile postedFile in uploadSubImage.PostedFiles)
                {
                    ...
                    if (pdata.HasValue)
                    {
                        ...
                        imgCompress.Height = 108;
                        imgCompress.Width = 108;
                        imgCompress.Save(postedFile.FileName, HttpContext.Current.Server.MapPath("~/Admin/subcategory/small/"));
                        imgCompress.Height = 224;
                        imgCompress.Width = 224;
                        imgCompress.Save(postedFile.FileName, HttpContext.Current.Server.MapPath("~/Admin/subcategory/medium/"));
                        imgCompress.Height = 300;
                        imgCompress.Width = 300;
                        imgCompress.Save(postedFile.FileName, HttpContext.Current.Server.MapPath("~/Admin/subcategory/large/"));
                        imgCompress.Height = 500;
                        imgCompress.Width = 500;
                        imgCompress.Save(postedFile.FileName, HttpContext.Current.Server.MapPath("~/Admin/subcategory/xlarge/"));
                    }
