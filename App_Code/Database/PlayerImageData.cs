...
/// <summary>
/// Summary description for PlayerImageData
/// </summary>
public class PlayerImageData
{
    ...
    public PlayerImageData(int Id)
    {
        Connection connect = new Connection();
        List<MySqlParameter> param = new List<MySqlParameter>();
        param.Add(new MySqlParameter("@int_Id", Id));
        using (DataSet ds = connect.GetDataset("SELECT * FROM playerimage WHERE id=@int_Id", param))
        {
    ...
    {
        List<MySqlParameter> param = new List<MySqlParameter>();
        param.Add(new MySqlParameter("@PRegid", PRegid));
        ...
        Connection connect = new Connection();
        connect.ExecStatement("INSERT INTO playerimage(imageName,PRegid)VALUES(@imageName,@PRegid) ", param);
