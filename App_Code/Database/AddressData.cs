...
public class AddressData
{
    ...
    public void Save()
    {
        ...
        Connection connect = new Connection();
        connect.ExecStatement("INSERT INTO address(customerid,state,city,cityzone,area,pincode,address1,address2,flotno,landmark,isprimary) VALUES(@customerid,@state,@city,@cityzone,@area,@pincode,@address1,@address2,@flotno,@landmark,@isprimary)", param);
        connect.Dispose();
        connect = null;
    }
    ...
    public void Update(int id)
    {
        ...
        Connection connect = new Connection();
        connect.ExecStatement("UPDATE address SET customerid=@customerid,city=@city,cityzone=@cityzone,area=@area,pincode=@pincode,address1=@address1,address2=@address2,flotno=@flotno,landmark=@landmark WHERE id=@id", param);
        connect.Dispose();
        connect = null;
    }
