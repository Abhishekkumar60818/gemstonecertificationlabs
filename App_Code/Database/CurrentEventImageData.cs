...
/// <summary>
/// Summary description for CurrentEventImageData
/// </summary>
public class CurrentEventImageData
{
    ...
    public CurrentEventImageData()
    {
        //
        // TODO: Add constructor logic here
        //
    }
    public CurrentEventImageData(int Id)
    {
        Connection connect = new Connection();
        List<MySqlParameter> param = new List<MySqlParameter>();
        param.Add(new MySqlParameter("@int_Id", Id));
        using (DataSet ds = connect.GetDataset("SELECT * FROM currentimage WHERE id=@int_Id", param))
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                HasValue = true;
                _Id = int.Parse(ds.Tables[0].Rows[0]["id"].ToString());
                _CurrentImage = ds.Tables[0].Rows[0]["CurrentImage"].ToString();
    ...
    public void Save()
    {
        ...
        param.Add(new MySqlParameter("@CurrentImage", _CurrentImage));
        ...
        Connection connect = new Connection();
        connect.ExecStatement("INSERT INTO currentimage(CurrentImage,CRegid)VALUES(@CurrentImage,@CRegid) ", param);
    ...
    public void Update(int id)
    {
        ...
        Connection connect = new Connection();
        connect.ExecStatement("UPDATE currentimage SET CurrentImage=@CurrentImage,CRegid=@CRegid WHERE id=@id", param);
        connect.Dispose();
        connect = null;
    }
