...
public class MyCartData
{
    ...
    public MyCartData(int id, string sessionid,string email)
    {
        ...
        if (email != "")
        {
            ...
            query = "SELECT * FROM cartdata WHERE productid=@int_Id and sessionid=@sessionid and userid=" + udata.Id;
        }
        else
        {
            query = "SELECT * FROM cartdata WHERE productid=@int_Id and sessionid=@sessionid and userid=0";
        }
    ...
    public MyCartData(int id, string sessionid, string email, string noUse)
    {
    ...
    public void Save()
    {
        ...
        Connection connect = new Connection();
        connect.ExecStatement("INSERT INTO cartdata(productid,price,newprice,size,quantity,sessionid,userid,ischeckout,discountid) VALUES(@productid,@price,@newprice,@size,@quantity,@sessionid,@userid,@ischeckout,@discountid)", param);
        connect.Dispose();
        connect = null;
    }

    public void Update(int pid, int userid, string sessionid)
    {
        List<MySqlParameter> param = new List<MySqlParameter>();
        ...
        Connection connect = new Connection();
        connect.ExecStatement("UPDATE cartdata SET quantity=@quantity WHERE productid=@pid and sessionid=@sessionid and userid=@uid", param);
        connect.Dispose();
        connect = null;
    }
    ...
    public void Update(string sessionid)
    {
        ...
        Connection connect = new Connection();
        connect.ExecStatement("UPDATE cartdata SET userid=@userid WHERE sessionid=@sessionid and userid=0", param);
        connect.Dispose();
        connect = null;
    }
